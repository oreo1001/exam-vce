    ...
    <div className="min-h-full bg-gray-50 dark:bg-gray-950 py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-lg mb-3">문제집 · 228문제</p>
          <div className="inline-flex items-center gap-2 bg-amber-50 dark:bg-amber-950 border border-amber-200 dark:border-amber-800 rounded-xl px-4 py-2">
            <svg className="w-4 h-4 text-amber-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
            </svg>
            <span className="text-xs text-amber-700 dark:text-amber-400">AI 번역본 (v15.65) · 이미지 없음 · 실제 덤프와 다를 수 있음</span>
          </div>
        </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-6">
          <Link href="/de-new/study" className="group block">
          ...
          <Link href="/de-new/test" className="group block">
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm hover:shadow-md hover:border-[#ff3621] dark:hover:border-[#ff3621] transition-all duration-200 group-hover:scale-[1.02]">
              <div className="flex items-center gap-4 mb-4">
        ...
        {wrongCount > 0 && (
          <Link href="/de-new/wrong" className="block">
